...
public class Menu {
	...
	public static void main(String[] args) {
		logger.debug("Started menu: LOGGER *************************s");
		Menu menu = new Menu();
	...
	private void checkBalance(BankAccount atm) {
		...
		logger.debug("Checked balance " + balance);
	...
	private void makeDeposit(BankAccount atm) {
		...
		logger.debug("User deposited " + extraMoney);
	...
	private void MakeWithdraw(BankAccount atm) {
		...
		logger.debug("User withdrew " + takingMoney);
	}
