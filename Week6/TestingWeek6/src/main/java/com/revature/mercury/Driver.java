...
public class Driver {
	...
	static String url = "http://newtours.demoaut.com/"; //application under test
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Any time you run the application and don't invoke this method, leaves an hidden chrome process in the background
		// that you have to close manually via the task manager
		driver.quit();
	}
